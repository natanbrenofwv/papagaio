...
function alertyes() {
    alert("Você esta completamente certo e com certeza é muito inteligente")
}
//declara variavel para armaxenar mo botao//
var topo = 0
var esquerda = 0
var mobileState = 0

//função que indentifica qual dispositivo que está sendo usado//
...
// definindo estados da posição do botão
let mobile_state = {
    1: { topMobile: 1, left: 1 },
    2: { topMobile: 1, left: 0 },
    3: { topMobile: 0, left: 0 },
    4: { topMobile: 0, left: 1 }

}
//verificadoe de para direcioar as funções
...
function webHandler(event) {
    ...
    //difirindo uma area de respiro no nosso botão
    ...
    if (distance < 80) {
        ...
        $("#not").css({topMod, left: left: leftMod, position: "relative"})
    }
//funcao que vai calcular o agulo do sno e do cosseno (sin e cos)
